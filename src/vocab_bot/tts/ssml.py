"""SSML builder for MAI-Voice-2 (architecture §7.2, test-spec §5).
...
The word is synthesized ~15% slower for clarity; sentences run at normal rate (plan §7).
"""
...
# en-US MAI-Voice-2 voices (plan §7 / §12).
VOICES: dict[str, str] = {
